...
for currentMemberID in memberIDList:
	if "VSL" in memberIDList[currentMemberID] and SPOUSE_MULTIPLIER>0 and "VEL" in memberIDList[currentMemberID] and int(memberIDList[currentMemberID]["VSL"]) > int(float(SPOUSE_MULTIPLIER)*int(memberIDList[currentMemberID]["VEL"])):
	...
	elif "VSA" in memberIDList[currentMemberID] and SPOUSE_MULTIPLIER>0 and "VEA" in memberIDList[currentMemberID] and int(memberIDList[currentMemberID]["VSA"]) > int(float(SPOUSE_MULTIPLIER)*int(memberIDList[currentMemberID]["VEA"])):
		totalStr+=addToTotalStr(currentMemberID,"VSA>"+str(SPOUSE_MULTIPLIER)+"*VEA");
		jiraStr+=addToJiraStr(currentMemberID,"VSA>"+str(SPOUSE_MULTIPLIER)+"*VEA");
	elif "VCA" in memberIDList[currentMemberID] and CHILD_MULTIPLIER>0 and "VEL" in memberIDList[currentMemberID] and int(memberIDList[currentMemberID]["VCA"]) > int(float(CHILD_MULTIPLIER)*int(memberIDList[currentMemberID]["VEA"])):
		totalStr+=addToTotalStr(currentMemberID,"VCA>"+str(CHILD_MULTIPLIER)+"*VEA");
		jiraStr+=addToJiraStr(currentMemberID,"VCA>"+str(CHILD_MULTIPLIER)+"*VEA");
